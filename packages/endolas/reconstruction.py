...
def reconstruct_film(calibration, start_row=0, end_row=18, start_col=0, end_col=18, grid_width=18, grid_height=18):
    ...
    """
    # preprocess the data
    points = preprocess_data(start_row, end_row, start_col, end_col)
    ...
    for frame_index in range(frames):
        ...
        # triangulate
        data.append(reconstruct(laser_grid, x_vec_undistorted, R, t))
...
def preprocess_data(start_row, end_row, start_col, end_col):
