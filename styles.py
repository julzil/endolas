...
# ----------------------------------------------------------------------------------------------------------------------
ID_2_LABEL_2_1 = {1: 'IoU, coarss, 32 filter',
                  2: 'IoU, coarse, 48 filter',
                  3: 'IoU, fine, 32 filter',
                  4: 'IoU, fine, 48 filter'}

ID_2_LABEL_2_2 = {1: 'IoU, coarss, 32 filter',
                  2: 'IoU, coarse, 48 filter',
                  3: 'IoU, fine, 32 filter',
                  4: 'IoU, fine, 48 filter'}
...
ID_2_COLOR_2_1 = {1: COLOR_POSTERIOR,
                  2: COLOR_ANTERIOR,
                  3: COLOR_TRUE,
                  4: COLOR_PREDICTION}

ID_2_COLOR_2_2 = {1: COLOR_POSTERIOR,
                  2: COLOR_ANTERIOR,
                  3: COLOR_TRUE,
                  4: COLOR_PREDICTION}
...
ID_2_COLOR_6_1 = {1: COLOR_POSTERIOR,
                  2: COLOR_ANTERIOR,
                  3: COLOR_TRUE,
                  4: COLOR_POSTERIOR,
                  5: COLOR_ANTERIOR,
